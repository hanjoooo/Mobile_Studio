...
import com.example.khanj.trust.handler.PlayRTCChannelViewListener
import com.example.khanj.trust.handler.PlayRTCDataChannelHandler
import com.example.khanj.trust.handler.PlayRTCHandler
import com.example.khanj.trust.util.Utils
import com.example.khanj.trust.view.PlayRTCChannelView
import com.example.khanj.trust.view.PlayRTCLogView
import com.example.khanj.trust.view.PlayRTCSnapshotView
import com.example.khanj.trust.view.PlayRTCVerticalSeekBar
import com.example.khanj.trust.view.PlayRTCVideoViewGroup
...
class PlayRTCActivity : Activity() {
    ...
    private fun initUIControls() {
        ...
        /* 채널 팝업 뷰 */
        channelInfoPopup = findViewById<View>(R.id.channel_info) as PlayRTCChannelView

        /*video 스트림 출력을 위한 PlayRTCVideoView의 부모 ViewGroup */
        videoLayer = findViewById<View>(R.id.videoarea) as PlayRTCVideoViewGroup

        /*video 스트림 출력을 위한 PlayRTCVideoView의 부모 ViewGroup */
        videoLayer = findViewById<View>(R.id.videoarea) as PlayRTCVideoViewGroup

        /* 로그 출력 TextView */
        logView = this.findViewById<View>(R.id.logtext) as PlayRTCLogView

        snapshotLayer = this.findViewById<View>(R.id.snapshot_area) as PlayRTCSnapshotView

        /* PlayRTC P2P Status report 출력 TextView */
        txtStatReport = this.findViewById<View>(R.id.txt_stat_report) as TextView
        val text = "Local\n ICE:none\n Frame:0x0x0\n Bandwidth[0bps]\n RTT[0]\n eModel[-]\n VFLost[0]\n AFLost[0]\n\nRemote\n ICE:none\n Frame:0x0x0\n Bandwidth[0bps]\n VFLost[0]\n AFLost[0]"
        txtStatReport!!.text = text


        /* 채널 팝업 버튼 */
        val channelPopup = this.findViewById<View>(R.id.btn_channel) as Button
    ...
    private fun initSwitchVideoCameraFunctionUIControls() {
        val cameraBtn = this.findViewById<View>(R.id.btn_switch_camera) as Button
    ...
    private fun initSwitchVideoCameraFlashFunctionUIControls() {
        val flashBtn = this.findViewById<View>(R.id.btn_switch_flash) as Button
    ...
    private fun initDataChannelFunctionUIControls() {
        ...
        val btnText = this.findViewById<View>(R.id.btn_text) as Button
        /* DataChannel 파일 전송 버튼 */
        val btnFile = this.findViewById<View>(R.id.btn_file) as Button
        ...
        if (playrtcType == 1 || playrtcType == 4) {
            ...
            btnFile.setOnClickListener(object : View.OnClickListener {
                override fun onClick(v: View) {
    ...
    private fun initLogViewFunctionUIControls() {
        /* 로그뷰  토글 버튼 이벤트 처리 */
        val btnLog = this.findViewById<View>(R.id.btn_log) as Button
        if (playrtcType < 3) {
    ...
    private fun initChannelCloseFunctionUIControls() {
        /* Peer 채널 퇴장 버튼 */
        val btnDisconnectChannel = this.findViewById<View>(R.id.btn_peerChClose) as Button
        btnDisconnectChannel.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View) {
        ...
        /*  채널 종료 버튼 */
        val btnCloseChannel = this.findViewById<View>(R.id.btn_chClose) as Button
        btnCloseChannel.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View) {
                if (playRTCHandler != null && playRTCHandler!!.isChannelConnected) {
    ...
    private fun initMediaMuteFunctionUIControls() {
        /* Local Video Mute 버튼 */
        val btnMuteLVideo = this.findViewById<View>(R.id.btn_local_vmute) as Button
        /* Local Video Mute 처리시 로컬 영상 스트림은 화면에 출력이 안되며 상대방에게 전달이 되지 않는다. */
        btnMuteLVideo.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View) {
                val b = v as Button
                if (playRTCHandler != null) {
        ...
        /* Local Audio Mute 버튼 */
        val btnMuteLAudio = this.findViewById<View>(R.id.btn_local_amute) as Button
        /* Local Audio Mute 처리시 로컬 음성 스트림은 상대방에게 전달이 되지 않는다. */
        btnMuteLAudio.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View) {
                val b = v as Button
                if (playRTCHandler != null) {
                    val text = b.text as String
        ...
        val btnMuteRVideo = this.findViewById<View>(R.id.btn_remote_vmute) as Button
        /* Remote Video Mute 처리시 상대방의 영상 스트림은 수신되나 화면에는 출력이 되지 않는다. */
        btnMuteRVideo.setOnClickListener(object : View.OnClickListener{
            override fun onClick(v: View) {
                val b = v as Button
                if (playRTCHandler != null) {
                    val text = b.text as String
        ...
        val btnMuteRAudio = this.findViewById<View>(R.id.btn_remote_amute) as Button
        /* Remote Video Mute 처리시 상대방 영상 스트림은 수신되나 소리는 출력되지 않는다. */
        btnMuteRAudio.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View) {
                val b = v as Button
                if (playRTCHandler != null) {
                    val text = b.text as String
    ...
    private fun initVideoViewMirrorFunctionUIControls() {
        val btnMirror = this.findViewById<View>(R.id.btn_mirror) as Button
        if (playrtcType < 3) {
            btnMirror.setOnClickListener(object : View.OnClickListener {
                override fun onClick(v: View) {
                    val layer = findViewById<View>(R.id.btn_mirror_layer) as RelativeLayout
                    if (layer.isShown) {
            ...
            (this.findViewById<View>(R.id.btn_mirror_on) as Button).setOnClickListener(object : View.OnClickListener {
                override fun onClick(v: View) {
                    (findViewById<View>(R.id.lb_btn_mirror) as TextView).text = "미러-On"
                    val view = videoLayer!!.localView
                    view!!.isMirror = true
                }
            })
            (this.findViewById<View>(R.id.btn_mirror_off) as Button).setOnClickListener(object : View.OnClickListener {
                override fun onClick(v: View) {
                    (findViewById<View>(R.id.lb_btn_mirror) as TextView).text = "미러-Off"
                    val view = videoLayer!!.localView
                    view!!.isMirror = false
                }
            })
        } else {
            (findViewById<View>(R.id.lb_btn_mirror) as TextView).visibility = View.GONE
        }
    }

    /* 카메라 영상 추가 회전 각 버튼 v2.2.9 */
    private fun initCameraDegreeFunctionUIControls() {
        val btnCameraDegree = this.findViewById<View>(R.id.btn_camera_degree) as Button
        if (playrtcType < 3) {
            btnCameraDegree.setOnClickListener(object : View.OnClickListener {
                override fun onClick(v: View) {
                    val layer = findViewById<View>(R.id.btn_camera_degree_layer) as RelativeLayout
                    if (layer.isShown) {
                        layer.visibility = View.GONE
                    } else {
                        hideFuntionUILayer()
            ...
            val cameraRotation0 = findViewById<View>(R.id.btn_camera_0) as Button
            cameraRotation0.setOnClickListener(object : View.OnClickListener {
                override fun onClick(v: View) {
                    setCameraRotation(0)
                }
            })
            val cameraRotation90 = this.findViewById<View>(R.id.btn_camera_90) as Button
            cameraRotation90.setOnClickListener(object : View.OnClickListener {
                override fun onClick(v: View) {
                    setCameraRotation(90)
                }
            })
            val cameraRotation180 = this.findViewById<View>(R.id.btn_camera_180) as Button
            cameraRotation180.setOnClickListener(object : View.OnClickListener {
                override fun onClick(v: View) {
                    setCameraRotation(180)
                }
            })
            val cameraRotation270 = this.findViewById<View>(R.id.btn_camera_270) as Button
            cameraRotation270.setOnClickListener(object : View.OnClickListener{
                override fun onClick(v: View) {
                    setCameraRotation(270)
                }
            })
        } else {
            (findViewById<View>(R.id.lb_camera_degree) as TextView).visibility = View.GONE
    ...
    private fun initCameraZoomFunctionUIControls() {
        val btnCameraZoom = this.findViewById<View>(R.id.btn_camera_zoom) as Button
        zoomRangeBar = this.findViewById<View>(R.id.seekbar_camera_zoom) as PlayRTCVerticalSeekBar
        if (playrtcType < 3) {
            btnCameraZoom.setOnClickListener(object : View.OnClickListener {
                override fun onClick(v: View) {

                    if (playRTCHandler == null) {
                        return
                    }
                    val layer = findViewById<View>(R.id.btn_camera_zoom_layer) as RelativeLayout
                    if (layer.isShown) {
                        layer.visibility = View.GONE
                    } else {
                        ...
                        (findViewById<View>(R.id.lb_camera_zoom_max) as TextView).text = zoomRange.maxValue.toString() + ""
                        (findViewById<View>(R.id.lb_camera_zoom_min) as TextView).text = zoomRange.minValue.toString() + ""
                        (findViewById<View>(R.id.lb_camera_zoom) as TextView).text = "Zoom: " + zoomLevel
            ...
            zoomRangeBar!!.setOnSeekBarChangeListener(object : OnSeekBarChangeListener {
                ...
                override fun onProgressChanged(seekBar: SeekBar, progress: Int, fromUser: Boolean) {
                    ...
                    (findViewById<View>(R.id.lb_camera_zoom) as TextView).text = "Zoom: " + progress
            ...
            (findViewById<View>(R.id.lb_camera_zoom) as TextView).visibility = View.GONE
    ...
    private fun initCameraWhitebalanceFunctionUIControls() {
        val btnCameraWbalance = this.findViewById<View>(R.id.btn_white_balance) as Button
        if (playrtcType < 3) {
            btnCameraWbalance.setOnClickListener(object : View.OnClickListener {
                override fun onClick(v: View) {

                    if (playRTCHandler == null) {
                        return
                    }
                    val layer = findViewById<View>(R.id.btn_white_balance_layer) as RelativeLayout
                    if (layer.isShown) {
                        layer.visibility = View.GONE
                    } else {
                        ...
                        (findViewById<View>(R.id.white_balance_label) as TextView).text = labelText
                        layer.visibility = View.VISIBLE
                    }
                }
            })

            (this.findViewById<View>(R.id.btn_white_balance_auto) as Button).setOnClickListener(object :View.OnClickListener {
                override fun onClick(v: View) {

                    if (playRTCHandler!!.setCameraWhiteBalance(PlayRTCWhiteBalance.Auto)) {
                        (findViewById<View>(R.id.white_balance_label) as TextView).text = "자동"
                    }
                }
            })
            (this.findViewById<View>(R.id.btn_white_balance_incandescent) as Button).setOnClickListener(object : View.OnClickListener {
                override fun onClick(v: View) {
                    ...
                    if (playRTCHandler!!.setCameraWhiteBalance(PlayRTCWhiteBalance.Incandescent)) {
                        (findViewById<View>(R.id.white_balance_label) as TextView).text = "백열등"
                    }
                }
            })
            (this.findViewById<View>(R.id.btn_white_balance_fluoreScent) as Button).setOnClickListener(object : View.OnClickListener {
                override fun onClick(v: View) {
                    ...
                    if (playRTCHandler!!.setCameraWhiteBalance(PlayRTCWhiteBalance.FluoreScent)) {
                        (findViewById<View>(R.id.white_balance_label) as TextView).text = "형광등"
                    }
                }
            })
            (this.findViewById<View>(R.id.btn_white_balance_daylight) as Button).setOnClickListener(object : View.OnClickListener {
                override fun onClick(v: View) {
                    ...
                    if (playRTCHandler!!.setCameraWhiteBalance(PlayRTCWhiteBalance.DayLight)) {
                        (findViewById<View>(R.id.white_balance_label) as TextView).text = "햇빛"
                    }
                }
            })
            (this.findViewById<View>(R.id.btn_white_balance_cloudydaylight) as Button).setOnClickListener(object :View.OnClickListener {
                override fun onClick(v: View) {
                    ...
                    if (playRTCHandler!!.setCameraWhiteBalance(PlayRTCWhiteBalance.CloudyDayLight)) {
                        (findViewById<View>(R.id.white_balance_label) as TextView).text = "흐림"
                    }
                }
            })
            (this.findViewById<View>(R.id.btn_white_balance_twilight) as Button).setOnClickListener(object : View.OnClickListener {
                override fun onClick(v: View) {
                    ...
                    if (playRTCHandler!!.setCameraWhiteBalance(PlayRTCWhiteBalance.TwiLight)) {
                        (findViewById<View>(R.id.white_balance_label) as TextView).text = "저녁빛"
                    }
                }
            })
            (this.findViewById<View>(R.id.btn_white_balance_shade) as Button).setOnClickListener(object :View.OnClickListener{
                override fun onClick(v: View) {
                    ...
                    if (playRTCHandler!!.setCameraWhiteBalance(PlayRTCWhiteBalance.Shade)) {
                        (findViewById<View>(R.id.white_balance_label) as TextView).text = "그늘"
                    }
                }
            })
        } else {
            (findViewById<View>(R.id.white_balance_label) as TextView).visibility = View.GONE
    ...
    private fun initCameraExposureFunctionUIControls() {
        ...
        val btnCameraExposure = this.findViewById<View>(R.id.btn_exposure_compensation) as Button
        exposureRangeBar = this.findViewById<View>(R.id.seekbar_exposure_compensation) as PlayRTCVerticalSeekBar
        if (playrtcType < 3) {

            btnCameraExposure.setOnClickListener(object : View.OnClickListener {
                override fun onClick(v: View) {
                    val layer = findViewById<View>(R.id.btn_exposure_compensation_layer) as RelativeLayout
                    if (layer.isShown) {
                        layer.visibility = View.GONE
                    } else {
                        hideFuntionUILayer()
                        ...
                        exposureRangeBar!!.setProgressAndThumb(exposureLevel!!.plus(max))
                        val sValue = String.format(Locale.getDefault(), "노출: %d", exposureLevel)
                        (findViewById<View>(R.id.lb_exposure_compensation) as TextView).text = sValue
                        (findViewById<View>(R.id.lb_exposure_compensation_max) as TextView).text = max.toString() + ""
                        (findViewById<View>(R.id.lb_exposure_compensation_min) as TextView).text = min.toString() + ""
                        layer.visibility = View.VISIBLE
                    }
                }
            })
            ...
            (findViewById<View>(R.id.lb_exposure_compensation) as TextView).visibility = View.GONE
    ...
    private fun initVideoViewShowSnapshotFunctionUIControls() {
        /* snapshot 레이어 보기 버튼 */
        val btnShowSnapshot = this.findViewById<View>(R.id.btn_show_snapshot) as Button
        if (playrtcType < 3) {


            btnShowSnapshot.setOnClickListener(object : View.OnClickListener {
                override fun onClick(v: View) {
    ...
    private fun hideFuntionUILayer() {
        (findViewById<View>(R.id.btn_mirror_layer) as RelativeLayout).visibility = View.GONE
        (findViewById<View>(R.id.btn_camera_degree_layer) as RelativeLayout).visibility = View.GONE
        (findViewById<View>(R.id.btn_camera_zoom_layer) as RelativeLayout).visibility = View.GONE
        (findViewById<View>(R.id.btn_white_balance_layer) as RelativeLayout).visibility = View.GONE
        (findViewById<View>(R.id.btn_exposure_compensation_layer) as RelativeLayout).visibility = View.GONE
    }
    ...
    private fun setCameraRotation(degree: Int) {
        ...
        if (playRTCHandler != null) {
            ...
            val text = findViewById<View>(R.id.lb_camera_degree) as TextView
    ...
    private fun initSnapshotControlls() {
        ...
        if (snapshotLayer != null && videoLayer != null) {
            snapshotLayer!!.createControls(object : PlayRTCSnapshotView.SnapshotLayerObserver {

                override fun onClickSnapshotImage(local: Boolean) {
                    if (local && videoLayer!!.localView != null) {

                        /*
                         * Snapshot 이미지 요청
                         */
                        videoLayer!!.localView!!.snapshot(object : PlayRTCVideoView.SnapshotObserver {

                            override fun onSnapshotImage(image: Bitmap) {
                    ...
                    } else if (local == false && videoLayer!!.localView != null) {
