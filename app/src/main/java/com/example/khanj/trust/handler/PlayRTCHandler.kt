package com.example.khanj.trust.handler
...
class PlayRTCHandler(activity: PlayRTCActivity) : PlayRTCObserver() {
    ...
    var cameraExposureCompensationRange: PlayRTCRange<Int>?=null
        get() = if (playRTC != null) {
     ...
     * @return int
     */
    var cameraExposureCompensation: Int?=null
        get() = if (playRTC != null) {
    ...
    override fun onConnectChannel(obj: PlayRTC?, channelId: String?, reason: String?, channelType: String?) {
        if (reason == "create") {
            ...
            activity!!.channelInfoPopup!!.setChannelId(channelId!!)
